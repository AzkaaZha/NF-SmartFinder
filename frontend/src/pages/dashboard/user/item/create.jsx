...
export default function CreateItemUser() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/dashboarduser/items"); // Kembali ke halaman daftar item
    } catch (err) {
  ...
  return (
    <div className="container-fluid">
      <h4 className="mb-4 d-flex justify-content-between align-items-center">
        Tambah Item Baru
        <button
          onClick={() => navigate("/dashboarduser/items")}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="d-flex justify-content-between mt-4">
              <button
                ...
                onClick={() => navigate("/dashboarduser/item")}
                disabled={loading}
              >
                Batal
              </button>
